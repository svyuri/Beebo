...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
     ...
     * the top and the mode is set to {@link org.zarroboogs.weibo.widget.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_START}. The default value is
     * <var>true</var> if {@link org.zarroboogs.weibo.widget.pulltorefresh.PullToRefreshBase#isPullToRefreshOverScrollEnabled()
    ...
    /**
     * Pass-through method for {@link org.zarroboogs.weibo.widget.pulltorefresh.PullToRefreshBase#getRefreshableView() getRefreshableView()}.
     * {@link android.widget.AdapterView#setAdapter(android.widget.Adapter)} setAdapter(adapter)}. This is just for
     * convenience!
     ...
     * Pull-to-Refresh can happen. An example of this state is when the Adapter View is scrolled to
     * the top and the mode is set to {@link org.zarroboogs.weibo.widget.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_START}
